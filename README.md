![Silly Logo.](https://github.com/P3kuru/Raidsheets/blob/main/banner.jpg)
...
- **Phase-by-phase mit sheets** — mitigation data organised by fight phase with notes
...
Since raid strategies and mitigation plans are always evolving, I rely on the community to keep these sheets accurate. You don't need to know how to code to help out!

### Share your Mitigation Plans

If you have a solid plan for a fight that isn't listed yet or a better version of an existing one, I'd love to see it.

- **Submit a Spreadsheet:** Link your Google Sheet or a screenshot of your plan in a GitHub Issue.
- **Correct a Mechanic:** If a timestamp is slightly off or a boss ability name is wrong, just let me know!

### Report an Issue

- **Missing Icons:** If an ability icon isn't showing up correctly.
...
Not affiliated with Square Enix. Mitigation plans are community suggestions — always adapt to your group's needs and cooldown availability.
